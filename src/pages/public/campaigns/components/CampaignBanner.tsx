            ...
            <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 max-w-7xl mx-auto">
                <div className="flex flex-col gap-1.5 max-w-2xl">
                    ...
                    <div className="flex items-baseline gap-3 mt-1">
                        <h1 className="text-3xl sm:text-4xl text-slate-900 dark:text-white tracking-tight font-extrabold">{campaign.description || t('publicCampaign.title')}</h1>
                    </div>
                ...
                <div className="flex flex-wrap items-center gap-3 pt-2 lg:pt-0">
                    ...
                    <button
                        onClick={() => {
                            ...
                            const text = `Check out this campaign performance report: ${url}`;
